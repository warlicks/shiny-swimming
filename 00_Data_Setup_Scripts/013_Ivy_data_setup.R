...
# Collect data
###############################################################################
## Get Each Weeks resutl for Ivy League
data_collection('Ivy League', date_param$mondays[1], date_param$sundays[1], con)
data_collection('Ivy League', date_param$mondays[2], date_param$sundays[2], con)
data_collection('Ivy League', date_param$mondays[3], date_param$sundays[3], con)
data_collection('Ivy League', date_param$mondays[4], date_param$sundays[4], con)
data_collection('Ivy League', date_param$mondays[5], date_param$sundays[5], con)
data_collection('Ivy League', date_param$mondays[6], date_param$sundays[6], con)
data_collection('Ivy League', date_param$mondays[7], date_param$sundays[7], con)
data_collection('Ivy League', date_param$mondays[8], date_param$sundays[8], con)
data_collection('Ivy League', date_param$mondays[9], date_param$sundays[9], con)
data_collection('Ivy League', date_param$mondays[10], date_param$sundays[10], con)
data_collection('Ivy League', date_param$mondays[11], date_param$sundays[11], con)
data_collection('Ivy League', date_param$mondays[12], date_param$sundays[12], con)
data_collection('Ivy League', date_param$mondays[13], date_param$sundays[13], con)
data_collection('Ivy League', date_param$mondays[14], date_param$sundays[14], con)
data_collection('Ivy League', date_param$mondays[15], date_param$sundays[15], con)
data_collection('Ivy League', date_param$mondays[16], date_param$sundays[16], con)
data_collection('Ivy League', date_param$mondays[17], date_param$sundays[17], con)
data_collection('Ivy League', date_param$mondays[18], date_param$sundays[18], con)
data_collection('Ivy League', date_param$mondays[19], date_param$sundays[19], con)
